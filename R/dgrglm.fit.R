...
#'  fit(formule, data)
#' }
dgrglm.fit <- function(formule, data, mode="BATCH", leaning_rate=0.1, max_iter=100, tolerance=1e-04, batch_size=NA, random_state=1, centering = FALSE){
  instance <- list()
